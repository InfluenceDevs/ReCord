...
export default async function () {
    const downloadUrl = "https://api.github.com/repos/InfluenceDevs/ReCord-Installer/releases";
    console.info(`ReCord Installer ${version}`);
    ...
    try {
        ...
        if (semverGreaterThan(latestVersion, version)) {
            ...
            const result = await dialog.showMessageBox({
                ...
                message: "A new version of the ReCord installer is available. Click \"Download\" to get the newest version.",
