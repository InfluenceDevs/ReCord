<script>
    ...
    function readLicenseFile() {
        fs.readFile(path.join(__static, "/license.txt"), (err, data) => {
            if (err) return licenseText = "See license at https://github.com/InfluenceDevs/ReCord/blob/main/LICENSE";
            licenseText = data;
        });
    }
...
<section class="page" in:page="{{duration: $hasLoaded ? undefined : 0}}" out:page="{{out: true}}">
    ...
    <PageHeader subtitle="End-User License Agreement for ReCord">
