...
<div class="social-links">
    <a use:tooltip={{text: "Website"}} aria-label="Website" class="social" id="web" target="_blank" rel="noreferrer" href={webUrl}>
    ...
    <a use:tooltip={{text: "GitHub"}} aria-label="GitHub" class="social" id="github" target="_blank" rel="noreferrer" href={githubUrl}>
    ...
    <a use:tooltip={{text: "Donate"}} aria-label="Donate" class="social" id="donate" target="_blank" rel="noreferrer" href={donateUrl}>
