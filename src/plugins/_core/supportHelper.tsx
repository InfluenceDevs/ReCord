...
async function generateDebugInfoMessage() {
    ...
    const info = {
        ReCord:
            `v${VERSION} • [${gitHash}](<https://github.com/InfluenceDevs/ReCord/commit/${gitHash}>)` +
