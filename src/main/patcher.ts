...
if (!IS_VANILLA) {
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "ReCord");
    ...
    console.log("[ReCord] Running in vanilla mode. Not loading ReCord");
}

console.log("[ReCord] Loading original Discord app.asar");
